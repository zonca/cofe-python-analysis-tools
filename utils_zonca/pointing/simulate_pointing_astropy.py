...
sampling_interval = TimeDelta(1/SAMPLING_FREQUENCY_HZ, format="sec")
time = start_time + sampling_interval * np.arange(0., HOURS*3600*SAMPLING_FREQUENCY_HZ)

rotation_speed = (-1 * 360/60)
ut_sec = np.arange(0., HOURS*3600, 1./SAMPLING_FREQUENCY_HZ)
az = rotation_speed * (ut_sec) % 360
